...
job_flow_overrides = {
    ...
    "Instances": {
        ...
        "Ec2SubnetId": "subnet-043c0026c4df05e20",
        "Ec2KeyName" : 'ubuntupair',
...
SPARK_STEPS_EXTRACTION = [
    {
        "Name": "Extract exchange_rate_api data",
        "ActionOnFailure": "CANCEL_AND_WAIT",
        "HadoopJarStep": {
            "Jar": "s3://us-east-1.elasticmapreduce/libs/script-runner/script-runner.jar",
            "Args": [
                "s3://raw-emr/scripts/exchange_rate_api.py",
            ],
        },
    },
   ]
...
with DAG('exchange_rate_api_analytics_spark_job_dag',
        ...
        is_extraction_completed >> remove_cluster >> is_emr_cluster_terminated >> end_pipeline